 ...
 * {@code com.github.pojomvcc.RootObjectCache}, without cloning all {@code V}s
 * in the {@code com.github.pojomvcc.RootObjectCache}.
 * <p/>
 * When a {@code V} is retrieved from this {@code com.github.pojomvcc.util.RevisionObjectList}
 * a clone of the original {@code V} in the {@code com.github.pojomvcc.RootObjectCache} is
...
public class RevisionObjectList<K, V> implements Iterable<V> {
   ...
   * {@code com.github.pojomvcc.RootObjectCache}. This is a direct {@link java.util.List} copy as seperate {@code java.util.List}s
   * are maintained for each revision in the {@code com.github.pojomvcc.RootObjectCache} and therefore there is no need
   ...
   * have been added to this {@code com.github.pojomvcc.RevisionObjectCache}. The order of this is important.
   */
  private List<K> addedElementKeys;

  /**
   * A {@code java.util.List} of {@code K}s for all {@code V}s that
   * have been removed from this {@code com.github.pojomvcc.RevisionObjectCache}.
   */
  private List<K> removedElementKeys;

  /**
   * A {@code java.util.List} of {@code K}s for all {@code V}s that
   * have been retrieved from this {@code com.github.pojomvcc.RevisionObjectCache}. Although they have been retrieved does not
  ...
  /**
   * The {@code com.github.pojomvcc.RootObjectCache} that owns this {@code com.github.pojomvcc.util.RevisionObjectList}.
   */
  private RootObjectCache<K, V> rootCache;

  /**
   * The revision from the {@code com.github.pojomvcc.RootObjectCache} that this {@code com.github.pojomvcc.util.RevisionObjectList}
   * is operating on.
   */
   ...
   * Constructor.
   *
   * @param cache    the {@code com.github.pojomvcc.RootObjectCache} that owns this {@code com.github.pojomvcc.util.RevisionObjectList}.
   * @param revision the revision from the {@code com.github.pojomvcc.RootObjectCache} that this {@code com.github.pojomvcc.util.RevisionObjectList}
   *                 is for.
   */
  ...
  /**
   * Returns {@code true} if this {@code com.github.pojomvcc.util.RevisionObjectList} is empty, {@code false} otherwise.
   *
   * @return
   */
   ...
   * or clones the provided {@link V} (using the {@link com.github.pojomvcc.CacheElementFactory}
   * registered with the {@link com.github.pojomvcc.RootObjectCache}) to return (the clone is also inserted into
   ...
   * {@link V} in this {@link com.github.pojomvcc.RevisionObjectCache}.
   *
   * @return
   */
  ...
  /**
   * Returns a {@code List} of {@link K} which contains all of the keys currently in this {@link com.github.pojomvcc.util.RevisionObjectList}/
   *
   * @return
   */
  ...
  private class RevisionObjectListIterator<V> implements Iterator<V> {
    ...
    public void remove() {
      throw new UnsupportedOperationException("com.github.pojomvcc.util.RevisionObjectList.RevisionObjectListIterator.remove");
    }

    /**
     * Determines if the {@code com.github.pojomvcc.util.RevisionObjectList} underlying this {@code java.util.Iterator} has
